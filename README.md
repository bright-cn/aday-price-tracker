...
[![Aday Price Tracker](https://img.shields.io/badge/Aday%20Price%20Tracker-Managed%20Solution-orange?style=flat-square)](https://bright.cn/products/insights/price-tracker/aday)
[![Python](https://img.shields.io/badge/Python-3.9%2B-yellow?style=flat-square)](https://python.org)

[![Bright Insights Price Tracker](https://raw.githubusercontent.com/danielshashko/bright-insights-assets/main/price-tracker-hero-v2.png)](https://bright.cn/products/insights/price-tracker/aday)

实时 Aday 价格追踪——一个电商平台。两种入门方式：**全托管**情报平台，或使用 Bright Data 的 AI Scraper Builder 构建的**自定义 scraper**。

---

## 选项 1：Bright Insights - AI 驱动的价格追踪（推荐）

**[Bright Insights](https://bright.cn/products/insights/price-tracker/aday)** 是 Bright Data 的全托管零售情报平台。无需构建 scraper，无需维护基础设施——只需将结构化、可直接分析的价格数据交付到仪表板、数据 feed 或你的 BI 工具中。
...
> **每月 $250 起 - [获取定制报价 →](https://bright.cn/products/insights/price-tracker/aday)**

---

## 选项 2：构建你自己的 Aday Scraper

没有预构建的 Aday scraper API？没问题。Bright Data 的 **AI Scraper Builder** 只需几次点击即可生成自定义 Aday scraper——无需编写代码。

### 几分钟内构建你的 Aday scraper

**[打开 Aday AI Scraper Builder →](https://bright.cn/products/web-scraper/aday)**
...
- 一个用于 Aday 的 **Web Scraper ID**（来自上面的构建步骤）
...
1. **克隆此 repository**
   ...
   ```bash
   git clone https://github.com/bright-cn/aday-price-tracker.git
...
3. **配置凭据**
   ...
   > **你的 Web Scraper ID**
   > 将你在 [AI Scraper Builder dashboard](https://bright.cn/products/web-scraper/aday) 中的 Web Scraper ID
...
一旦你的 Aday scraper 已构建完成，并且已在 `.env` 中配置好 Web Scraper ID，Python 接口的使用方式如下：

### 1. 按 URL 追踪特定产品

传入 Aday 产品 URL 列表以获取结构化价格数据：
...
- 🌟 [Aday Price Tracker - Bright Insights (Managed)](https://bright.cn/products/insights/price-tracker/aday)
- 🏗️ [构建 Aday Scraper](https://bright.cn/products/web-scraper/aday)
...
*由 [Bright Data](https://bright.cn) 构建——行业领先的网页数据平台。*