...
Info  : https://bright.cn/products/insights/price-tracker/aday
"""
...
# https://bright.cn/products/web-scraper/aday
DATASET_ID = os.getenv("BRIGHTDATA_DATASET_ID", "")
if not DATASET_ID:
    raise EnvironmentError(
        "BRIGHTDATA_DATASET_ID is not set.\n"
        "1. Build your Aday scraper at: https://bright.cn/products/web-scraper/aday\n"
